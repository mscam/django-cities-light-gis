...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.geometry'
        db.add_column(u'cities_light_city', 'geometry',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'City.search_names'
        db.alter_column(u'cities_light_city', 'search_names', self.gf('cities_light.abstract_models.ToSearchTextField')(max_length=4000))

    def backwards(self, orm):
        # Deleting field 'City.geometry'
        db.delete_column(u'cities_light_city', 'geometry')


        # Changing field 'City.search_names'
        db.alter_column(u'cities_light_city', 'search_names', self.gf('cities_light.models.ToSearchTextField')(max_length=4000))
